...
module azureManagementGroup 'iom/azureManagementGroupRoleAssignment.bicep' = if (assignAzureManagementGroupPermissions) {
  name: '${deploymentNamePrefix}-azureManagementGroup-${deploymentNameSuffix}'
